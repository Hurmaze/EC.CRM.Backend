...
namespace EC.CRM.Backend.Persistence.Migrations
{
    ...
    [Migration("20240602203255_Make mentor valuation composite key")]
    partial class Makementorvaluationcompositekey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EC.CRM.Backend.Domain.Entities.TOPSIS.MentorValuation", b =>
                {
                    ...
                    b.Property<bool>("WasSetByMentor")
                        .HasColumnType("bit");

                    b.HasKey("StudentUid", "MentorUid");
